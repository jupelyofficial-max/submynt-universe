...
import { computeConsiderIf, computeKeyStrengths, computeSkipIf, computeValueScore } from "@/lib/subscriptionIntelligence";
 ...
 * hand-written per subscription. "Best for" tags moved to the panel header
 * (DetailPanel.tsx), not shown here anymore. */
